			...
			<AnimatePresence>
				{isOpen && (
					<motion.div
						...
						className="absolute right-0 mt-2 w-[calc(100vw-2rem)] sm:w-96 max-w-96 bg-[var(--surface)] border border-[var(--color-border)] rounded-lg shadow-lg z-50 overflow-hidden"
					>
						{/* ── Header ──────────────────────────────────────────────── */}
