	...
	if (typeof document === "undefined") return null;
		...
		>
			...
			<div className="relative z-10 flex items-center justify-center min-h-screen p-4 sm:p-6">
				<div className={clsx("w-full", maxWidthClass, "bg-[var(--surface)] rounded-xl shadow-lg border border-[var(--color-border)] transform transition-all duration-200 ease-out scale-95 opacity-0 data-[open]:scale-100 data-[open]:opacity-100 max-h-[95vh] overflow-hidden")} data-open={open ? "true" : undefined}>
					{children}
				</div>
			</div>
		</div>,
