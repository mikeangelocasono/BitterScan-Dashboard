...
// Apply date range filtering for the records list
	...
	}, [allValidScans, dateRangeType, getDateRangeForFilter]);
...
// Filter records by validated_at date to match the selected range
	...
	}, [validationHistory, dateRangeType, getDateRangeForFilter]);
	...
	// Calculate total pages and paginated records
													...
													<body>
														<div class="header">
															<div style="display: flex; align-items: center; gap: 16px; margin-bottom: 12px;">
																...
																<div>
																	<h1 style="margin: 0;">Validation History Report</h1>
																	<p style="color: #666; font-size: 13px; margin-top: 4px;">Expert validation records and AI prediction comparison</p>
																</div>
															</div>
														</div>
														...
														<div style="margin-bottom: 25px; padding: 15px; background: #f0f7f1; border-radius: 6px; border-left: 4px solid #388E3C;">
															<p style="font-size: 13px; color: #333; margin: 4px 0;"><strong>Confirmed (AI Matched):</strong> ${validRecords.filter((r: ValidationHistoryRecord) => r.status === 'Validated').length}</p>
															<p style="font-size: 13px; color: #333; margin: 4px 0;"><strong>Corrected (Expert Changed):</strong> ${validRecords.filter((r: ValidationHistoryRecord) => r.status === 'Corrected').length}</p>
														</div>
														<table>
															<thead>
																<tr>
														...
														<footer style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #e0e0e0; text-align: center; color: #666; font-size: 11px;">
